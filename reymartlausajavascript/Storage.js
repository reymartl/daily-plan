...
function RemoveItem() {
	var name = document.forms.ListOfTask.name;
...
function doShowAll() {
	if (CheckBrowser()) {
		var key = "";
		var list = "<tr><th>Full name</th><th>Task</th><th>Priority</th><th>Date</th><th>Time</th></tr>\n";
		var i = 0;
		...
		if (list == "<tr><th>Full name</th><th>Task</th><th>Priority</th><th>Date</th><th>Time</th></tr>\n") {
